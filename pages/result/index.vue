<template>
  <div>
    ...
    <div class="body-text">
      {{ $t("getResult.explanation") }}
      <span class="font-italic secondary--text">58a70606a835c400c8b38e84</span>
      {{ $t("getResult.idInput") }}
      <br />
      <v-text-field
        v-model="id"
    ...
    return {
      ...
      meta: [
        { hid: "title", name: "title", content: this.$t("results.seo.title") },
        {
          hid: "description",
          name: "description",
          content: this.$t("results.seo.description")
        },
        ...
        // Open Graph
        {
          hid: "og:title",
          name: "og:title",
          content: this.$t("results.seo.title")
        },
        {
          hid: "og:description",
          name: "og:description",

  ...
  frontpage: {
    ...
    cards: {
      ...
      scientific: {
        title: "Tieteellinen",
        text:
          "BigFive on tieteellisesti validoitu ja luotettava psykologinen malli."
      },
      translated: {
        title: "Käännetty",
        text:
          'Käännetty yli 20 kielelle. Auttaa <a href="https://b5.translations.alheimsins.net/" rel="noreferrer" target="blank">tässä</a>!'
      }
    },
    description: {
      top:
        "Seuraava testi sisältää 120 kysymystä, joiden suorittamisen arvioidaan vievän noin 10 minuuttia.",
      subtop: "The",
      subtop2:

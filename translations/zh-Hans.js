export default {
  ...
  frontpage: {
    ...
    no_registration: "完成测试后，你将能够查看结果。",
    ...
    cards: {
      ...
      translated: {
        title: "已翻译",
        text:
          '翻译成 20 多种语言。帮助 <a href="https://b5.translations.alheimsins.net/" rel="noreferrer" target="blank">here</a>!'
      }
    },
    description: {
      top: "以下测试包含120个问题，估计需要10分钟才能完成。",
      subtop: "的",
  ...
  inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      info:
        "没有“正确”或“错误”的答案。在开始测试之前，请确保你在一个安静的地方，在那里你可以不受干扰地专注于自己。",
      result:

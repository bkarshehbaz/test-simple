export default {
  ...
  frontpage: {
    ...
    no_registration: "Après le test, vous pourrez voir les résultats.",
    ...
    cards: {
      ...
      scientific: {
        title: "Scientifique",
        text:
          "BigFive est un modèle psychologique scientifiquement validé et fiable."
      },
      translated: {
        title: "Traduit",
        text:
          'Traduit dans plus de 20 langues. Aider <a href="https://b5.translations.alheimsins.net/" rel="noreferrer" target="blank">here</a>!'
      }
    },
    description: {
      top:
        "Le test suivant contient 120 questions qui devraient vous prendre environ 10 minutes.",
      subtop: "The",
      subtop2:
  ...
  inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      info:
        "Il n'y a pas de bonnes ou de mauvaises réponses. Avant de commencer le test, assurez-vous que vous êtes dans un endroit calme où vous ne serez pas dérangé. ",
      result:

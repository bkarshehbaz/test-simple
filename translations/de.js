export default {
  ...
  frontpage: {
    ...
    no_registration:
      "Nach Abschluss des Tests können Sie eine Beschreibung Ihres persönlichen Profils einsehen.   ",
    ...
    cards: {
      ...
      scientific: {
        ...
        text:
          "BigFive ist ein wissenschaftlich validiertes und zuverlässiges Modell zur Persönlichkeitsmessung."
      },
      translated: {
        title: "Übersetzung",
        text:
          'Übersetzt in über 20 Sprachen. Hilf mit <a href="https://b5.translations.alheimsins.net/" rel="noreferrer" target="blank">hier</a>!'
      }
    },
    description: {
      top:
        "Der folgende Test umfasst 120 Fragen und beansprucht schätzungsweise 10 Minuten Ihrer Zeit.",
      subtop: "Der",
      subtop2:
...
inventory is from <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      info:
        "Was zählt, sind Ihre persönlichen Meinungen und Eindrücke, wobei es kein richtig oder falsch gibt. Bitte antworten Sie zügig „aus dem Bauch heraus“, denn Ihre erste spontane Antwort ist meistens die zutreffendste. ",
      result:
